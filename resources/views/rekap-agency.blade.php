...
<style>
   ...
   BILLING FILTER / PILL RADIO
    ...
    /* BORDER RADIO MENGIKUT WARNA AKTIF */
...
<div class="container-fluid">
    ...
    <div class="billing-filter">
        ...
        {{-- BILLING 1 & 2 --}}
        <a href="{{ route('rekap.agency', [
            'view' => 'rekap',
            'agency_psb' => request('agency_psb'),
            'sales_agency' => request('sales_agency'),
            'date_from' => request('date_from')
        ]) }}"
        class="billing-filter-item {{ request('view', 'rekap') == 'rekap' ? 'active' : '' }}">
        ...
        class="billing-filter-item billing-1 {{ request('view') == 'billing1' ? 'active' : '' }}">
        ...
        class="billing-filter-item billing-2 {{ request('view') == 'billing2' ? 'active' : '' }}">
            ...
            <div class="card-body">
                ...
                <div class="row g-2 mb-4">
                    ...
                    <div class="col-md-3 col-6">
                        ...
                        <div class="card bg-light border-0 summary-card rounded-3"
                            ...
                            <div class="card-body text-center">
                                ...
                                <h5 class="mb-0 fw-bold mt-1 text-dark">
                                    {{ number_format($summary['total_customer'] ?? 0) }}
                                </h5>
                    ...
                    <div class="col-md-3 col-6">
                        ...
                        <div class="card bg-success bg-opacity-10 border-0 summary-card rounded-3"
                             style="border: 1px solid #d1e7dd !important;">
                            ...
                            <div class="card-body text-center">
                                ...
                                <h5 class="mb-0 text-success fw-bold mt-1">
                                    {{ number_format($summary['total_sudah_bayar'] ?? 0) }}
                                </h5>
                    ...
                    <div class="col-md-3 col-6">
                        ...
                        <div class="card bg-danger bg-opacity-10 border-0 summary-card rounded-3"
                             style="border: 1px solid #f8d7da !important;">
                            ...
                            <div class="card-body text-center">
                                ...
                                <h5 class="mb-0 text-danger fw-bold mt-1">
                                    {{ number_format($summary['total_belum_bayar'] ?? 0) }}
                                </h5>
                    ...
                    <div class="col-md-3 col-6">
                        ...
                        <div class="card bg-info bg-opacity-10 border-0 summary-card rounded-3"
                             style="border: 1px solid #cff4fc !important;">
                    ...
                    <table class="table table-bordered table-hover table-striped mb-0">
                        ...
                        <thead class="table-dark">
                            ...
                            <tr>
                                ...
                                <th rowspan="2"
                                    style="vertical-align:middle;min-width:45px;"
                                    class="text-center">
                                    No
                                </th>
                                ...
                                <th colspan="2"
                                    class="text-center"
                                    style="background-color:#E2001A;color:white;">
                                    Billing 1
                                </th>

                                <th colspan="2"
                                    class="text-center"
                                    style="background-color:#2F3A4A;color:white;">
                                    Billing 2
                                </th>
                            ...
                            <tr>
                                ...
                                <th class="text-center"
                                    style="background-color:#E2001A;color:white;width:80px;">
                                    SSL
                                </th>

                                <th class="text-end"
                                    style="background-color:#E2001A;color:white;width:120px;">
                                    Saldo
                                </th>
                                ...
                                {{-- BILLING 2 --}}
                                <th class="text-center"
                                    style="background-color:#2F3A4A;color:white;width:80px;">
                                    SSL
                                </th>

                                <th class="text-end"
                                    style="background-color:#2F3A4A;color:white;width:120px;">
                                    Saldo
                                </th>
                                ...
                                {{-- TOTAL --}}
                                <th class="text-center"
                                    style="background-color:#28a745;color:white;width:80px;">
                                    SSL
                                </th>

                                <th class="text-end"
                                    style="background-color:#28a745;color:white;width:120px;">
                                    Saldo
                                </th>
